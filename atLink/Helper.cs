...
internal static class Helper
{
    ...
    internal static void CreateLinks(this IConfigLink configLink, UIApplication uiApp)
    {
        using Document doc = uiApp.ActiveUIDocument.Document;

        bool isCurrentWorkset = configLink.IsCurrentWorkset;
        bool setWorksetId = !isCurrentWorkset && configLink.Worksets.Length > 0;
