...
public class FileLogger : ILogger
{
    ...
    {
        _stream.WriteLine($"Started work at {DateTime.Now} on {file}");
    }

    public void FileOpened()
    {
        _stream.WriteLine("File successfully opened.");
    }

    public void Success(string message)
    {
        _stream.WriteLine($"Success at {DateTime.Now}. {message}");
    }
    ...
    {
        _stream.WriteLine($"MD5 Hash of file is: {hash} at {DateTime.Now}");
    }

    public void TimeForFile(DateTime startTime)
    {
        _stream.WriteLine($"Time spent for file {DateTime.Now - startTime}");
    }

    public void TimeTotal()
    {
        _stream.WriteLine($"Total time spent {DateTime.Now - _startTime}");
    }

    public void ErrorTotal()
    {
        _stream.WriteLine($"Done! There were {ErrorCount} errors.");
    }
