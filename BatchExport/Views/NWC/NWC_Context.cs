...
namespace AlterTools.BatchExport.Views.NWC
{
    ...
    {
        private static readonly IReadOnlyDictionary<NavisworksCoordinates, string> _coordinates = new Dictionary<NavisworksCoordinates, string>()
        {
        ...
        private static readonly IReadOnlyDictionary<NavisworksParameters, string> _parameters = new Dictionary<NavisworksParameters, string>()
        {
